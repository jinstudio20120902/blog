        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">博客管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
							<li>
							...
							<li>
                                <a href="#">类别管理 <span class="fa arrow"></span></a>
                                
								<ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="blog1.html">文章类别</a>
                                    </li>
                                </ul>
							...
							<li>
								...
								<ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="blog2.html">评论设置</a>
                                    </li>
                                </ul>
								
                            </li>
							<li>
                                <a href="#">标签管理 <span class="fa arrow"></span></a>
                                
								<ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="blog3.html">我的标签</a>
                                    </li>
                                </ul>
					 ...
					 <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-envelope"></i> <span class="nav-label">留言板</span></a>
                    </li>
